    ...
    return (
        <header className={`${styles.header} ${scrolled ? styles.scrolled : ""}`}>
            <nav className={styles.nav}>
                ...
                <Link href="/lien-he" className={styles.ctaDesktop}>
                    Tư vấn miễn phí
            ...
            {menuOpen && (
                ...
                >
                    <div className={styles.mobileLinks}>
                        ...
                        <Link href="/lien-he" onClick={() => setMenuOpen(false)}>Liên hệ</Link>
                    </div>
                    <Link href="/lien-he" className={styles.ctaMobile} onClick={() => setMenuOpen(false)}>
                        Tư vấn miễn phí
                    </Link>
                </div>
            )}
