    ...
    const projects = [
        {
            ...
            tag: "TEAMBUILDING",
            color: "#F97316",
            href: "/dich-vu/to-chuc-teambuilding",
        },
        {
            ...
            tag: "YEAR END PARTY",
            color: "#8B5CF6",
            href: "/dich-vu/to-chuc-year-end-party",
        },
        {
            ...
            tag: "COMPANY TRIP",
            color: "#22C55E",
            href: "/dich-vu/to-chuc-company-trip",
        },
        {
            ...
            tag: "SPORTS DAY",
            color: "#EF4444",
            href: "/dich-vu/to-chuc-sports-day",
        },
        {
            ...
            defaultImage: "https://njchsjhdkcfaouqwyutc.supabase.co/storage/v1/object/public/post-images/1774841552125-d6rsss2mtnr.webp",
            tag: "WORKSHOP",
            color: "#3B82F6",
            href: "/dich-vu/to-chuc-workshop",
        },
        {
            ...
            tag: "FAMILY DAY",
            color: "#F59E0B",
            href: "/dich-vu/to-chuc-family-day",
        },
    ];
        ...
        <section className={styles.section} id="portfolio">
            <div className={styles.container}>
                ...
                <div className={styles.header}>
                    ...
                    <Link href="/du-an" className="btn btn--outline">
                        XEM TẤT CẢ →
                    </Link>
                </div>
                    ...
                    {projects.map((p) => (
                        <Link href={p.href} key={p.title} className={styles.card}>
                            <div className={styles.imgWrap}>
                                <Image src={images[p.imageKey] || p.defaultImage} alt={p.title} fill style={{ objectFit: 'cover' }} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
