...
export const metadata: Metadata = {
    ...
    keywords: 'về sự kiện toàn quốc, giới thiệu đơn vị sự kiện, event agency việt nam, đơn vị tổ chức sự kiện uy tín',
    openGraph: {
        ...
        <div className={styles.page}>
            ...
            <article className={styles.mainContent}>
                <div className={styles.proseContainer}>
                    ...
                    <p>Khác biệt với các đơn vị du lịch lấn sân làm sự kiện ghép đoàn, chúng tôi khẳng định năng lực trọn vẹn của một đơn vị giải trí (Entertainment Agency) thực thụ:</p>
                    ...
                    <div className={styles.tableWrapper}>
                        <table>
                            <thead>
                                <tr>
                                    <th>Năng lực Cốt lõi</th>
                                    <th>Chỉ số Cam kết Thực tế</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td className={styles.tableHighlight}>Quy trình vận hành 1-Chạm</td>
                                    <td>Khách hàng được cung cấp một Account Manager độc quyền duy nhất. Mọi yêu cầu từ thay đổi Concept đến bổ sung Micro đều được giải quyết tức thì không qua nhiều khâu trung gian chờ đợi.</td>
                                </tr>
                                <tr>
                                    <td className={styles.tableHighlight}>Đội ngũ MC "Linh hồn"</td>
                                    <td>100% Cán bộ quản trò (MC) đều sinh ra từ các cuộc thi hùng biện quốc gia, sở hữu nội lực giọng nói cực tốt, kỹ năng xử lý cháy nổ sân khấu và xử lý đám đông kích động ở đẳng cấp Master.</td>
                                </tr>
                                <tr>
                                    <td className={styles.tableHighlight}>Máy móc nhập khẩu 100%</td>
                                    <td>Không dàn xếp sang tay bên thứ ba (bán thầu). Chúng tôi sở hữu riêng kho khổng lồ hệ thống Moving Head, Laser, và Màn LED P3 ngoài trời. Kiểm soát tuyệt đối vật tư phần cứng rủi ro.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <p>Chúng tôi thấu hiểu rằng: Mỗi đồng ngân sách của doanh nghiệp bạn xuất ra đều đáng bằng xương bằng máu. Trong tư trình vận hành của Sự Kiện Toàn Quốc, không bao giờ có khái niệm "Tiêu chuẩn tối thiểu". Mọi chi tiết nhỏ từ hoa ly trên bàn tiệc, nhiệt độ chuẩn của rượu Vang hay chiếc dù che nắng chòi nghỉ chân ngoài bãi biển, đều chứa đựng thái độ chăm sóc khắc nghiệt nhất mà chúng tôi gửi gắm.</p>
