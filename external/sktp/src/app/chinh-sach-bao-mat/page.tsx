            ...
            <main className={styles.policyPage}>
                <div className={styles.container}>
                    ...
                    <section>
                        ...
                        <p>
                            Quý khách có quyền yêu cầu chúng tôi cập nhật, thay đổi hoặc xóa bỏ thông tin cá nhân của mình khỏi hệ thống lưu trữ bất cứ lúc nào bằng cách liên hệ qua Hotline hoặc Email chính thức của chúng tôi.
                        </p>
                    </section>
