...
const post = {
    title: "Hướng Dẫn Sử Dụng MetaTrader 4 (MT4) Chi Tiết Cho Người Mới 2026",
    slug: "huong-dan-su-dung-mt4-chi-tiet",
    category: "huong-dan",
    excerpt: "Hướng dẫn toàn diện cách sử dụng nền tảng giao dịch MetaTrader 4 từ A-Z. Từ cài đặt, giao diện, đặt lệnh, đến sử dụng indicator và EA cho người mới bắt đầu.",
    meta_title: "Hướng Dẫn Sử Dụng MT4 Chi Tiết Từ A-Z Cho Người Mới 2026",
    meta_description: "Học cách sử dụng MetaTrader 4 (MT4) từ cơ bản đến nâng cao. Hướng dẫn cài đặt, phân tích biểu đồ, đặt lệnh Buy/Sell, cài indicator và EA Expert Advisor.",
    tags: ["MT4", "MetaTrader 4", "hướng dẫn", "nền tảng giao dịch", "forex"],
    featured_image: "https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?auto=compress&cs=tinysrgb&w=800",
    featured_image_alt: "Hướng dẫn sử dụng MetaTrader 4 chi tiết",
    is_published: true,
...
<p>Đây là cách đặt lệnh nhanh nhất — mua/bán ngay tại giá hiện tại. Các bước thực hiện:</p>

<p>Nhấn phím <strong>F9</strong> hoặc click vào nút "New Order" trên thanh công cụ. Cửa sổ Order sẽ hiện ra với các thông tin cần điền:</p>
...
<li><strong>Type:</strong> Chọn "Market Execution"</li>
</ul>
...
<p>Sử dụng phím tắt giúp bạn thao tác nhanh hơn rất nhiều. Dưới đây là một số phím tắt quan trọng nhất bạn nên ghi nhớ:</p>
...
<li><strong>Ctrl + Y:</strong> Hiển thị đường phân cách thời gian</li>
</ul>
...
async function main() {
    ...
    if (error) {
        ...
        console.log(`✅ Created post: [ID: ${data.id}] ${data.title}`);
        console.log(`   URL: https://sanuytin.net/kien-thuc-forex/${data.slug}`);
    }
}
