    ...
    return (
        <main className="min-h-screen bg-background pt-[120px] relative">
            ...
            <div className="relative border-b border-border/40 bg-background/50 backdrop-blur-sm">
                ...
                <div className="container-custom relative pt-8 pb-8 md:pt-12 md:pb-10">
                    {/* Breadcrumb */}
                    <div className="flex items-center gap-2 text-xs md:text-sm text-muted-foreground mb-8 font-medium">
                    ...
                    <div className="max-w-4xl">
                        <div className="flex items-center gap-3 mb-5">
                            <span className="text-[11px] font-bold uppercase tracking-wider text-primary bg-primary/10 border border-primary/20 px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm shadow-primary/5">
                                <Sparkles size={12} /> Cập nhật 24/7
                            </span>
                        </div>

                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-4 tracking-tight leading-[1.1] flex items-center gap-3">
                            <Newspaper className="text-primary/80 hidden md:block" size={48} />
