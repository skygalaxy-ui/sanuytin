        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">Dữ liệu từ Supabase • {brokers.length} sàn giao dịch</p>
                </div>
            ...
            {(isCreating || editingId !== null) && (
                <div className="bg-slate-900/80 backdrop-blur border border-slate-800 rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Tên sàn</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Điểm đánh giá</label>
                            <input
                                type="number"
                                step="0.1"
                                min="0"
                        ...
                        <div className="md:col-span-2 lg:col-span-1">
                            ...
                            <div className="flex items-start gap-4">
                                {/* Preview */}
                                <div className="w-20 h-20 bg-slate-800 border border-slate-700 rounded-lg flex items-center justify-center overflow-hidden shrink-0">
                                    {formData.logo ? (
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Spread</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Đòn bẩy tối đa</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Nạp tối thiểu</label>
                            <input
                                type="text"
                                placeholder="vd: $50"
                                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white outline-none focus:border-primary"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Giấy phép</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Link đăng ký (affiliate)</label>
                            <input
                                type="text"
                                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white outline-none focus:border-primary"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Năm thành lập</label>
                            <input
                                type="number"
                                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white outline-none focus:border-primary"
                        ...
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Trụ sở</label>
                            <input
                                type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Ưu điểm (mỗi dòng 1 ưu điểm)</label>
                            <textarea
                                rows={3}
                                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white outline-none focus:border-primary resize-none"
                                value={(formData.pros || []).join('\n')}
                                onChange={(e) => setFormData({ ...formData, pros: e.target.value.split('\n').filter(p => p.trim()) })}
                            />
                        </div>
                        <div>
                            <label className="block text-sm text-slate-400 mb-1">Nhược điểm (mỗi dòng 1 nhược điểm)</label>
                            <textarea
                                rows={3}
                                className="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white outline-none focus:border-primary resize-none"
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-slate-800 bg-slate-800/50">
                                ...
                                <th className="text-left text-xs font-bold text-slate-400 uppercase tracking-wider px-6 py-4">Spread</th>
                                <th className="text-left text-xs font-bold text-slate-400 uppercase tracking-wider px-6 py-4">Đòn bẩy</th>
                                ...
                                <tr key={broker.id} className="hover:bg-slate-800/50 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className="text-white font-medium">{broker.score}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4 text-white">{broker.avg_spread}</td>
                                    <td className="px-6 py-4 text-white">{broker.max_lev}</td>
                                    <td className="px-6 py-4">
