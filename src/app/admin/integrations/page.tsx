        ...
        <div className="space-y-6 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button onClick={handleSave} disabled={saving}
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm disabled:opacity-50 transition-all hover:shadow-lg hover:shadow-orange-500/25 w-fit">
                            ...
                            <input type="text" value={settings.ga4_measurement_id}
                                ...
                                className={`w-full px-4 py-3 border rounded-xl text-sm font-mono focus:outline-none focus:ring-2 transition-all ${settings.ga4_measurement_id && !isGA4Valid
                                        ...
                                        : isGA4Valid
                                            ...
                                            : 'border-gray-200 focus:ring-orange-500/10'
                                    }`}
                            />
                            {isGA4Valid && (
                    ...
                    {settings.ga4_enabled && isGA4Valid && (
                        <div className="flex items-center gap-3 pt-2">
                            <a href="https://analytics.google.com" target="_blank" rel="noopener"
                                className="inline-flex items-center gap-2 px-4 py-2 bg-orange-50 border border-orange-200 text-orange-700 rounded-xl text-sm font-medium hover:bg-orange-100 transition-colors">
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" value={settings.gsc_verification_code}
                            ...
                            className={`w-full px-4 py-3 border rounded-xl text-sm font-mono focus:outline-none focus:ring-2 transition-all ${isGSCValid ? 'border-emerald-300 focus:ring-emerald-500/20' : 'border-gray-200 focus:ring-orange-500/10'
                                }`}
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" value={settings.gsc_property_url}
                            ...
                            placeholder="https://sanuytin.net"
                            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/10 transition-all"
                        />
                    ...
                    {settings.gsc_enabled && (
                        <div className="flex items-center gap-3 pt-2">
                            <a href={settings.gsc_property_url
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 text-blue-700 rounded-xl text-sm font-medium hover:bg-blue-100 transition-colors">
                            ...
                            <a href={settings.gsc_property_url
                                ...
                                : '#'}
                                target="_blank" rel="noopener"
                                className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-200 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-100 transition-colors">
            ...
            <div className="bg-gray-50 rounded-2xl border border-gray-200 p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                    {[
                        ...
                        { label: 'PageSpeed Insights', url: `https://pagespeed.web.dev/analysis?url=${encodeURIComponent(settings.gsc_property_url || 'https://sanuytin.net')}`, icon: <Globe size={14} />, color: 'text-emerald-600 bg-emerald-50 border-emerald-200' },
