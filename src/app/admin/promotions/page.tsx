    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-500/90 hover:to-purple-600/90 text-gray-900 font-medium rounded-xl transition-all hover:scale-105 hover:shadow-lg hover:shadow-pink-500/25">
                    <Plus size={18} />
                    Thêm khuyến mãi
                </button>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 border border-emerald-500/30 rounded-2xl p-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-50/80 rounded-xl flex items-center justify-center text-emerald-400">
                            <CheckCircle size={20} />
                        </div>
                        <div>
                ...
                <div className="bg-gradient-to-br from-slate-500/20 to-slate-600/10 border border-slate-500/30 rounded-2xl p-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-50/80 rounded-xl flex items-center justify-center text-gray-500">
                            <XCircle size={20} />
                        </div>
                        <div>
                ...
                <div className="bg-gradient-to-br from-pink-500/20 to-pink-600/10 border border-pink-500/30 rounded-2xl p-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-50/80 rounded-xl flex items-center justify-center text-pink-400">
                            <Gift size={20} />
                        </div>
                        <div>
                ...
                <div className="bg-gradient-to-br from-amber-500/20 to-amber-600/10 border border-amber-500/30 rounded-2xl p-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-50/80 rounded-xl flex items-center justify-center text-amber-400">
                            <Clock size={20} />
                        </div>
                        <div>
            ...
            <div className="relative max-w-md">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white/80 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 outline-none focus:border-primary transition-colors"
                    value={searchTerm}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredPromotions.map((promo) => (
                    <div
                        key={promo.id}
                        className={`bg-white/80 backdrop-blur border rounded-2xl p-5 transition-all hover:scale-[1.02] group ${promo.isActive ? 'border-gray-200 hover:border-pink-500/50' : 'border-gray-200/50 opacity-70'
                            }`}
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${promo.isActive
                                ...
                                <Gift size={24} className={promo.isActive ? 'text-pink-400' : 'text-gray-400'} />
                            </div>
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button className="p-2 text-gray-500 hover:text-primary hover:bg-gray-50 rounded-lg transition-colors">
                                    <Edit2 size={16} />
                                </button>
                                <button className="p-2 text-gray-500 hover:text-red-400 hover:bg-gray-50 rounded-lg transition-colors">
                                    <Trash2 size={16} />
                                </button>
                            </div>
                        </div>
                        ...
                        <h3 className="text-gray-900 font-bold text-lg mb-2 group-hover:text-pink-400 transition-colors">
                            {promo.title}
                        </h3>
                        {promo.description && (
                        ...
                        <div className="space-y-3 pt-4 border-t border-gray-200">
                            <div className="flex items-center justify-between">
                                ...
                                <code className="px-2.5 py-1 bg-gray-50 text-primary rounded-lg font-mono text-xs font-medium">
                                    {promo.code}
                                </code>
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-gray-700 text-sm">{promo.endDate}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                {promo.isActive ? (
                                    ...
                                    <span className="flex items-center gap-1.5 px-2.5 py-1 bg-gray-50 text-gray-500 text-xs font-medium rounded-lg">
                ...
                {/* Add New Card */}
                <button className="bg-white/50 border-2 border-dashed border-gray-300 rounded-2xl p-5 flex flex-col items-center justify-center min-h-[280px] hover:border-pink-500/50 hover:bg-white/80 transition-all group">
                    <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-gradient-to-br group-hover:from-pink-500/20 group-hover:to-purple-500/20 transition-all">
                        <Plus size={28} className="text-gray-500 group-hover:text-pink-400 transition-colors" />
                    </div>
            ...
            {filteredPromotions.length === 0 && (
                <div className="bg-white/80 border border-gray-200 rounded-2xl p-16 text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Không tìm thấy khuyến mãi</h3>
