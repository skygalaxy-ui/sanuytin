...
const menuItems = [
    ...
    { label: "Quản lý Sàn", href: "/admin/brokers", icon: TrendingUp },
    ...
    { label: "Sửa giao diện", href: "/admin/theme-editor", icon: Monitor },
                ...
                {!collapsed && (
                    <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-sm">
                            <span className="text-white font-black text-[8px]">SUT</span>
                        </div>
                        <div>
                            <h1 className="text-sm font-bold text-gray-900 leading-tight">Sàn Uy Tín</h1>
                            <p className="text-[10px] text-gray-400 leading-tight">Admin System</p>
                        </div>
                    </div>
                )}
                {collapsed && (
                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mx-auto shadow-sm">
                        <span className="text-white font-black text-[7px]">SUT</span>
                    </div>
                )}
            </div>
            ...
            <div className="border-t border-gray-100 p-3 space-y-1 flex-shrink-0">
                ...
                {!collapsed && (
                    <div className="px-3 pt-2 pb-1">
                        <p className="text-[10px] text-gray-300 text-center">© {new Date().getFullYear()} Sàn Uy Tín</p>
                    </div>
                )}
            </div>
        </aside>
