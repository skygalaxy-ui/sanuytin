...
export default function Steps() {
    ...
    return (
        <section id="guide" className="py-20 bg-slate-900 text-white overflow-hidden relative">
            ...
            <div className="container-custom relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/3">
                        ...
                        <button className="bg-white text-slate-900 hover:bg-slate-100 px-8 py-3 rounded-lg font-bold transition-colors">
                    ...
                    <div className="lg:w-2/3 grid sm:grid-cols-2 gap-8">
                        {steps.map((step, index) => (
                            <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-2xl relative hover:border-primary/50 transition-colors">
                                <div className="absolute -top-4 -left-4 w-10 h-10 bg-primary rounded-full flex items-center justify-center font-bold text-white shadow-lg shadow-blue-900/50">
                                    {index + 1}
                                </div>
